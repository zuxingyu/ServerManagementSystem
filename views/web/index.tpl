              ...
              <li class="dropdown divided">
                ...
                <ul class="dropdown-menu wider arrow nopadding messages">
                  ...
                  <li>
                    <a class="cyan" href="#">
                      <div class="profile-photo">
                        <img src="/static/assets/images/ici-avatar.jpg" alt />
                      </div>
                  ...
                  <li>
                    <a class="green" href="#">
                      <div class="profile-photo">
                        <img src="/static/assets/images/arnold-avatar.jpg" alt />
                      </div>
                      <div class="message-info">
                  ...
                  <li>
                    <a href="#">
                      <div class="profile-photo">
                        <img src="/static/assets/images/profile-photo.jpg" alt />
                      </div>
                      <div class="message-info">
                  ...
                  <li>
                    <a class="red" href="#">
                      <div class="profile-photo">
                        <img src="/static/assets/images/peter-avatar.jpg" alt />
                      </div>
                      <div class="message-info">
                  ...
                  <li>
                    <a class="orange" href="#">
                      <div class="profile-photo">
                        <img src="/static/assets/images/george-avatar.jpg" alt />
                      </div>
                      <div class="message-info">
                ...
                <section class="tile transparent recent-activity">
                  ...
                  <div class="tile-body tab-content nopadding rounded-bottom-corners">
                    ...
                    <ul id="users-tab" class="tab-pane fade in active">
                      <li>
                        <img src="/static/assets/images/peter-avatar.jpg" class="w35" alt>
                      ...
                      <li>
                        <img src="/static/assets/images/arnold-avatar.jpg" class="w35" alt>
                      ...
                      <li>
                        <img src="/static/assets/images/ici-avatar.jpg" class="w35" alt>
                    ...
                    <ul id="orders-tab" class="tab-pane fade">
                      ...
                      <li>
                        <img src="/static/assets/images/george-avatar.jpg" class="w35" alt>
                    ...
                    <ul id="messages-tab" class="tab-pane fade">
                      <li>
                        <img src="/static/assets/images/profile-photo.jpg" class="w35" alt>
            ...
            <div class="tab-pane active" id="mmenu-users">
              ...
              <ul class="users-list">
                ...
                <li class="online">
                  <div class="media">
                    <a class="pull-left profile-photo" href="#">
                      <img class="media-object" src="/static/assets/images/ici-avatar.jpg" alt>
                    </a>
                    <div class="media-body">
                ...
                <li class="online">
                  <div class="media">
                    ...
                    <a class="pull-left profile-photo" href="#">
                      <img class="media-object" src="/static/assets/images/arnold-avatar.jpg" alt>
                    </a>
                ...
                <li class="online">
                  <div class="media">
                    <a class="pull-left profile-photo" href="#">
                      <img class="media-object" src="/static/assets/images/peter-avatar.jpg" alt>
                ...
                <li class="online">
                  <div class="media">
                    <a class="pull-left profile-photo" href="#">
                      <img class="media-object" src="/static/assets/images/george-avatar.jpg" alt>
                    </a>
                    <div class="media-body">
                ...
                <li class="busy">
                  <div class="media">
                    <a class="pull-left profile-photo" href="#">
                      <img class="media-object" src="/static/assets/images/random-avatar1.jpg" alt>
                    </a>
                    <div class="media-body">
                ...
                <li class="busy">
                  <div class="media">
                    <a class="pull-left profile-photo" href="#">
                      <img class="media-object" src="/static/assets/images/random-avatar2.jpg" alt>
                    </a>
                    <div class="media-body">
              ...
              <ul class="users-list">
                ...
                <li class="offline">
                  <div class="media">
                    <a class="pull-left profile-photo" href="#">
                      <img class="media-object" src="/static/assets/images/random-avatar4.jpg" alt>
                    </a>
                    <div class="media-body">
                ...
                <li class="offline">
                  <div class="media">
                    ...
                    <a class="pull-left profile-photo" href="#">
                      <img class="media-object" src="/static/assets/images/random-avatar5.jpg" alt>
                    </a>
                ...
                <li class="offline">
                  <div class="media">
                    <a class="pull-left profile-photo" href="#">
                      <img class="media-object" src="/static/assets/images/random-avatar6.jpg" alt>
                ...
                <li class="offline">
                  <div class="media">
                    <a class="pull-left profile-photo" href="#">
                      <img class="media-object" src="/static/assets/images/random-avatar7.jpg" alt>
                    </a>
                    <div class="media-body">
                ...
                <li class="offline">
                  <div class="media">
                    <a class="pull-left profile-photo" href="#">
                      <img class="media-object" src="/static/assets/images/random-avatar8.jpg" alt>
                    </a>
                    <div class="media-body">
